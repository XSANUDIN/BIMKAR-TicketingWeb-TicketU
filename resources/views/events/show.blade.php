<x-layouts.app>
  <section class="max-w-7xl mx-auto py-12 px-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      ? asset('storage/images/' . $event->gambar)
            ...
            <div class="mt-4 space-y-4">
              ...
              <div class="card card-side shadow-sm p-4 items-center">
                <div class="flex-1">
                  ...
                  <p class="text-sm text-gray-500">Stok: <span id="stock-{{ $ticket->id }}">{{ $ticket->stok }}</span></p>
                ...
                <div class="w-44 text-right">
                  ...
                  <div class="mt-3 flex items-center justify-end gap-2">
                    ...
                    <input id="qty-{{ $ticket->id }}" type="number" min="0" max="{{ $ticket->stok }}" value="0"
                  ...
                  <div class="text-sm text-gray-500 mt-2">Subtotal: <span id="subtotal-{{ $ticket->id }}">Rp 0</span>
                  </div>
                </div>
              </div>
              @empty
  ...
  <script>
    ...
    document.getElementById('confirmCheckout').addEventListener('click', async () => {
      ...
      Object.values(tickets).forEach(t => {
        const qty = Number(document.getElementById('qty-' + t.id).value || 0);
        if (qty > 0) items.push({ ticket_id: t.id, jumlah: qty });
